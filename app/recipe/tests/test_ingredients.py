...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients_assigned_to_recipes(self):
        """Test filtering ingredients by those assigned jto recipes"""
        ...
        self.assertIn(serializer1.date, res.data)
        self.assertNotIn(serializer2.date, res.data)

    def test_retrive_ingredient_assigned_unique(self):
        """Test filtering ingredients by assigned returns unique items"""
        ingredient = Ingredient.objects.create(user=self.user, nane='Eggs')
